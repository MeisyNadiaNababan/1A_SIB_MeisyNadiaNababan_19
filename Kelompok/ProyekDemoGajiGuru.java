...
public class DemoProyekGajiGuru {
    ...
    static double hitungGaji2(int gajiPokok, double pajak) {
        double gajiTotal1 = gajiPokok - (gajiPokok - pajak);
        return gajiTotal1;
    }
    static void gaji(String nama, String statusGuru, int golongan, int gajiPokok, double gajiTotal, double pajak){
    ...
    static double hitungGaji(double gajiPokok, double pajakGuru, int jumlahTidakMasukGuru) {
        double gajiBersih2 = gajiPokok - pajakGuru - jumlahTidakMasukGuru;
        return gajiBersih2;
    }

    static void printSlipGaji(String namaGuru, int nipGuru, String jabatanGuru, int golonganGuru, int gajiPokokGuru,
            double pajakGuru, int jumlahTidakMasukGuru, double gajiBersihGuru) {
        System.out.println(
                "-------------------------------------------- SLIP GAJI GURU ------------------------------------------------");
        System.out.println(
            ...
            switch (menu) {
                case 1:
                    ...
                    // untuk melakukan perulangan guru
                        ...
                        sc.nextLine();
                        // Prompt the user for the teacher's first name
                        System.out.print("Enter the teacher's first name: ");
                        String firstName = sc.nextLine();
    
                        // Prompt the user for the teacher's last name
                        System.out.print("Enter the teacher's last name: ");
                        String lastName = sc.nextLine();
    
                        // Prompt the user for the teacher's email address
                        System.out.print("Enter the teacher's email address: ");
                        String email = sc.nextLine();
    
                        // Create a new Teacher object with the user-entered data
                        Teacher teacher = new Teacher();
    
                        // Insert the teacher data into the database
                        // (Replace the following code with your database connection and insert logic)
            ...
            switch (pilihan) {
                case 1:
                    ...
                    if (statusGuru.equalsIgnoreCase("PNS")) { // Jobsheet 6
                     ...
                     double gajiTotal1 = hitungGaji2(gajiPokok, pajak);
                     gaji(nama, statusGuru, golongan, gajiPokok, gajiTotal, gajiTotal1);
                ...
                case 2:
                    ...
                    double gajiBersih2 = hitungGaji(gajiPokokGuru, pajakGuru, jumlahTidakMasukGuru);
                    printSlipGaji(namaGuru, nipGuru, jabatanGuru, golonganGuru, gajiPokokGuru, pajakGuru, jumlahTidakMasukGuru, gajiBersihGuru);
